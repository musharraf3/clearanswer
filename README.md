...
The glass-box report for `eob_06`, a planted error where the "you owe" column is $150 more than the sum of its parts. Deterministic code catches the discrepancy, the worker model explains it with machine-verified citations, and the case is routed to a human:
