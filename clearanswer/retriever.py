...
Design choice: lexical BM25 instead of embeddings. For a domain where users and
auditors must be able to see WHY a passage was retrieved, term-level scores beat
opaque vector similarity — every retrieval in the output lists the matched terms
and the score. Deterministic, reproducible, zero dependencies, works offline.
(An embedding reranker can be layered on later without changing the contract.)
"""
